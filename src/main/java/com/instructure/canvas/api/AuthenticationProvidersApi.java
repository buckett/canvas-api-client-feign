...
import com.instructure.canvas.model.AuthenticationProvider;
import com.instructure.canvas.model.SSOSettings;
...
public interface AuthenticationProvidersApi extends ApiClient.Api {
   ...
   */
  @RequestLine("POST /v1/accounts/{accountId}/authentication_providers")
  @Headers({
      "Content-Type: application/json",
      "Accept: application/json",
  })
  AuthenticationProvider addAuthenticationProvider(@Param("accountId") String accountId);
   ...
   */
  @RequestLine("DELETE /v1/accounts/{accountId}/authentication_providers/{id}")
  @Headers({
      "Content-Type: application/json",
      "Accept: */*",
  })
  void deleteAuthenticationProvider(@Param("accountId") String accountId, @Param("id") String id);
   ...
   * @return AuthenticationProvider
   */
  @RequestLine("GET /v1/accounts/{accountId}/authentication_providers/{id}")
  @Headers({
      "Accept: application/json",
  })
  AuthenticationProvider getAuthenticationProvider(@Param("accountId") String accountId, @Param("id") String id);
   ...
   */
  @RequestLine("GET /v1/accounts/{accountId}/authentication_providers")
  @Headers({
      "Accept: application/json",
  })
  List<AuthenticationProvider> listAuthenticationProviders(@Param("accountId") String accountId);
  ...
  List<AuthenticationProvider> listAuthenticationProviders(URI uri);
   ...
   * @return SSOSettings
   */
  @RequestLine("GET /v1/accounts/{accountId}/sso_settings")
  @Headers({
      "Accept: application/json",
  })
  SSOSettings showAccountAuthSettings(@Param("accountId") String accountId);
   ...
   * @return SSOSettings
   */
  @RequestLine("PUT /v1/accounts/{accountId}/sso_settings")
  @Headers({
      "Content-Type: application/json",
      "Accept: application/json",
  })
  SSOSettings updateAccountAuthSettings(@Param("accountId") String accountId);
   ...
   * @return AuthenticationProvider
   */
  @RequestLine("PUT /v1/accounts/{accountId}/authentication_providers/{id}")
  @Headers({
      "Content-Type: application/json",
      "Accept: application/json",
  })
  AuthenticationProvider updateAuthenticationProvider(@Param("accountId") String accountId, @Param("id") String id);
