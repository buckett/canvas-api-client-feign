...
public class AuthenticationProvidersApiTest {
    ...
    @Before
    public void setup() {
        api = new ApiClient().buildClient(AuthenticationProvidersApi.class);
    }
     ...
     */
    @Test
    public void addAuthenticationProviderTest() {
        String accountId = null;
        // AuthenticationProvider response = api.addAuthenticationProvider(accountId);
     ...
     */
    @Test
    public void deleteAuthenticationProviderTest() {
        String accountId = null;
        String id = null;
        // api.deleteAuthenticationProvider(accountId, id);
     ...
     */
    @Test
    public void getAuthenticationProviderTest() {
        String accountId = null;
        String id = null;
        // AuthenticationProvider response = api.getAuthenticationProvider(accountId, id);
     ...
     */
    @Test
    public void listAuthenticationProvidersTest() {
        String accountId = null;
        // List<AuthenticationProvider> response = api.listAuthenticationProviders(accountId);
     ...
     */
    @Test
    public void showAccountAuthSettingsTest() {
        String accountId = null;
        // SSOSettings response = api.showAccountAuthSettings(accountId);
     ...
     */
    @Test
    public void updateAccountAuthSettingsTest() {
        String accountId = null;
        // SSOSettings response = api.updateAccountAuthSettings(accountId);
     ...
     */
    @Test
    public void updateAuthenticationProviderTest() {
        String accountId = null;
        String id = null;
        // AuthenticationProvider response = api.updateAuthenticationProvider(accountId, id);
